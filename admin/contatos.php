            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">
                    <b class="lead text-todas-areas">Contatos</b>
                  </h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      <?php
                        $sqlConsultaProgramas     = "SELECT * FROM contato ORDER BY id ASC";
                      ...
                      ?>
                          <tr>
                            ...
                            <td>
                              <a href="contato.php?id=<?php echo $consultaProgramas->id; ?>" class="btn btn-info btn-xs btn-center col-lg-12"><i class="fa fa-plus"></i> Visualizar</a>
                            </td>
                          </tr>
                      <?php } ?>
                    </tbody>
